...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/learn/intermediate`,          lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE}/learn/advanced`,              lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE}/learn/languages/bangla`,      lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/learn/languages/english`,     lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE}/practice/words`,     lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/practice/sentences`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/practice/quotes`,    lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/practice/numbers`,   lastModified: now, changeFrequency: "monthly", priority: 0.65 },
    { url: `${BASE}/practice/custom`,    lastModified: now, changeFrequency: "monthly", priority: 0.65 },
